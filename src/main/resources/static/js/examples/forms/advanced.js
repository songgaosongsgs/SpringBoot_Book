...
$(function(){
    ...
    $("#select2-example-tags_2").select2({
        placeholder: "Select a country",
        //allowClear: true,
        tags: true,
        tokenSeparators: [',']
    });
    $("#select2-example-tags_3").select2({
        placeholder: "Select a country",
        //allowClear: true,
        tags: true,
        tokenSeparators: [',']
    });
    $("#select2-example-tags_4").select2({
        placeholder: "Select a country",
        //allowClear: true,
        tags: true,
        tokenSeparators: [',']
    });
    $("#select2-example-tags_5").select2({
        placeholder: "Select a country",
        //allowClear: true,
        tags: true,
        tokenSeparators: [',']
    });
    $("#select2-example-tags_6").select2({
        placeholder: "Select a country",
        //allowClear: true,
        tags: true,
        tokenSeparators: [',']
    });
    $("#select2-example-tags_7").select2({
        placeholder: "Select a country",
        //allowClear: true,
        tags: true,
        tokenSeparators: [',']
    });
    $("#select2-example-tags_8").select2({
        placeholder: "Select a country",
        //allowClear: true,
        tags: true,
        tokenSeparators: [',']
    });
    $("#select2-example-tags_9").select2({
        placeholder: "Select a country",
        //allowClear: true,
        tags: true,
        tokenSeparators: [',']
    });
    $("#select2-example-tags_10").select2({
        placeholder: "Select a country",
        //allowClear: true,
        tags: true,
        tokenSeparators: [',']
    });
    $("#select2-example-tags_11").select2({
        placeholder: "Select a country",
        //allowClear: true,
        tags: true,
        tokenSeparators: [',']
    });
    $("#select2-example-tags_12").select2({
        placeholder: "Select a country",
        //allowClear: true,
        tags: true,
        tokenSeparators: [',']
